...
const Home = () => {
    return (
        <main>
        <div className="bg-dark-cyan h-screen grid grid-cols-12 gap-5">
            <section className="col-span-8 flex flex-col gap-y-20 justify-center bg-android-developers bg-contain">
                ...
                <h2 className="text-3xl font-semibold text-white text-center font-mono">Welcome to my portfolio website!</h2>
            </section>
